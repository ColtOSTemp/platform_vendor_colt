...
COLT_BUILD_DATE_UTC := $(shell date -d '$(COLT_DATE_YEAR)-$(COLT_DATE_MONTH)-$(COLT_DATE_DAY) $(COLT_DATE_HOUR):$(COLT_DATE_MINUTE) UTC' +%s)
...
PRODUCT_GENERIC_PROPERTIES += \
  ...
  ro.colt.build_date_utc=$(COLT_BUILD_DATE_UTC) \
